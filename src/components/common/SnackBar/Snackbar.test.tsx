...
describe('SnackBar Component', () => {
  ...
  describe('Behavior', () => {
    it('should call onDismiss after duration', () => {
      ...
      render(
        <SnackBar visible={true} message="Test message" duration={100} onDismiss={onDismiss} />
      )
  ...
  describe('Animations', () => {
    it('should trigger animation when becoming visible', () => {
      const { rerender } = render(
        <SnackBar visible={false} message="Test message" onDismiss={() => jest.fn()} />
      )

      const animatedSpy = jest.spyOn(Animated, 'parallel')

      rerender(<SnackBar visible={true} message="Test message" onDismiss={() => jest.fn()} />)
