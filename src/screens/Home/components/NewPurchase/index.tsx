...
export const NewPurchase: React.FC<NewPurchaseProps> = ({ isVisible, onSave, onClose }) => {
  const { formData, categories, isFormValid, handleChange, handleSubmit, resetForm } =
  ...
  return (
    ...
    >
      <PurchaseForm categories={categories} formData={formData} onChange={handleChange} />
    </FormModal>
  )
}
